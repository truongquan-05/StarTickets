...
const SideBar: React.FC<SideBarProps> = ({
  ...
  const menuContent = (
    ...
    >
      ...
      {/* Quản Lý Đơn Vé - tất cả có thể xem (menu = 1, 3, 4) */}
      ...
      {(menu == 1 || menu == 3 || menu == 4) && (
        ...
        >
          ...
          {/* Thêm Lịch Chiếu - admin và theater staff */}
          {(menu == 1 || menu == 4) && (
            <Menu.Item
              key="/admin/lichchieu/add"
      ...
      {/* Quản Lý Dịch vụ */}
      <Menu.SubMenu key="food" icon={<GiftOutlined />} title="Quản Lý Dịch vụ">
        {/* Quản Lý Đồ Ăn - tất cả có thể xem, admin và theater staff có thể thêm/sửa/xóa */}
        {(menu == 1 || menu == 3 || menu == 4) && (
      ...
      {/* Quản Lý Rạp - staff có thể xem, chỉ admin có thể thêm mới */}
      {(menu == 1 || menu == 3 || menu == 4) && (
      ...
      {/* Quản Lý Phòng Chiếu - admin và theater staff có thể xem, staff chỉ xem */}
      {(menu == 1 || menu == 3 || menu == 4) && (
        <Menu.SubMenu
          key="phongchieu"
          icon={<VideoCameraAddOutlined />}
        ...
        >
          ...
          {/* Phòng Chiếu Chưa Xuất - chỉ admin */}
          {menu == 1 && (
            <Menu.Item
          ...
          {/* Thêm Mới Phòng Chiếu - chỉ admin */}
          {menu == 1 && (
      ...
      {/* Quản Lý Phản Hồi - admin và theater staff */}
      {(menu == 1 || menu == 4) && (
        <Menu.SubMenu
          key="comment"
          icon={<MailOutlined />}
        ...
        >
          {/* Phản Hồi Người Dùng - chỉ admin và theater staff */}
          <Menu.Item
            key="/admin/comment/phanhoinguoidung"
            icon={<CommentOutlined />}
          >
            <Link to="/admin/comment/phanhoinguoidung">
              Phản Hồi Người Dùng
            </Link>
          </Menu.Item>

          {/* Quản Lý Đánh Giá - admin và theater staff */}
      ...
      {/* Quản Lý Đánh Giá riêng cho Staff - chỉ xem */}
      {menu == 3 && (
        <Menu.Item key="/admin/danh-gia/list" icon={<StarOutlined />}>
          <Link to="/admin/danh-gia/list">Quản Lý Đánh Giá</Link>
        </Menu.Item>
